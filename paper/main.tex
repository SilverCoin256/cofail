...
$36$--$64\%$ of models. The exception is HellaSwag's participation ratio ($2.44\times$). The
eigenvalue count above the null edge is unchanged on four of five benchmarks.
...
(ARC), $5$ (Winogrande), $5$ (TruthfulQA), $4$ (GSM8K) and $12$ (HellaSwag), and they are stable
under deduplication --- across thresholds $0.99$ to $0.90$ they move by at most one on four of the
five benchmarks (HellaSwag ranges $8$--$12$). We report this as the dimensionality estimate and
