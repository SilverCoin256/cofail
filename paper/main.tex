...
and redrawing the null each time, $14$ of $15$ statistic--benchmark pairs move by less than
...
(Gebru et al.\ schema) and Croissant~1.0 metadata; each number traces to a JSON file emitted by an
