...
on every read. The audit covers **all five benchmarks**, 324 models in total, with **zero
mismatches**: ARC 149/149, TruthfulQA 60/60, GSM8K 60/60, Winogrande 40/40, HellaSwag 15/15.
