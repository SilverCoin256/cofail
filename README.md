...
~320 models across all five benchmarks with **zero mismatches** (ARC 149/149, TruthfulQA
60/60, GSM8K 60/60, Winogrande 40/40, HellaSwag 12/12), with a row-count guard on every read
