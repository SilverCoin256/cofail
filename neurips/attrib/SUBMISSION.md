# 3rd Workshop on Attributing Model Behavior at Scale (ATTRIB 2026)

Staged 2026-09-04 11:39 IST by `scripts/stage_submissions.sh` from `paper/workshops/attrib/`.
This file and the two beside it (`main.pdf`, `main.tex`, `neurips_2026.sty`) are a mirror —
edit the paper in `paper/workshops/attrib/`, never here, then re-run the staging script.
...
| **Track** | Main track (NOT idea track) |
| **Blinding** | Double-blind — anonymised (dblblindworkshop) |
| **Deadline** | Sat Sep 6, 17:29 IST (Sep 5 23:59 AoE) — **re-verify on the portal**; every one of these four has been extended at least once already |
| **Content pages at last stage** | 3.34 |
